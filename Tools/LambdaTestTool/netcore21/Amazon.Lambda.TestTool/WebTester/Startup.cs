    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            app.Use(async (context, next) =>
            {
                ...
                var embeddedResourceName = "Amazon.Lambda.TestTool.WebTester.embedded_wwwroot" + context.Request.Path.Value.Replace('/', '.');
                var items = this.GetType().Assembly.GetManifestResourceNames();
