...
```
    cd "StateMachineDefinitionStringTest"
    dotnet restore
```

Execute unit tests
```
    cd "StateMachineDefinitionStringTest/test/StateMachineDefinitionStringTest.Tests"
    dotnet test
```

Deploy application
```
    cd "StateMachineDefinitionStringTest/src/StateMachineDefinitionStringTest"
