...
```
    cd "Use11ASPNetCoreDependencies"
    dotnet restore
```

Execute unit tests
```
    cd "Use11ASPNetCoreDependencies/test/Use11ASPNetCoreDependencies.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Use11ASPNetCoreDependencies/src/Use11ASPNetCoreDependencies"
