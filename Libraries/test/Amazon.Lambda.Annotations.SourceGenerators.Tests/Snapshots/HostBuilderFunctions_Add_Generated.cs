...
namespace TestHostBuilderApp
{
    public class HostBuilderFunctions_Add_Generated
    {
        ...
        public HostBuilderFunctions_Add_Generated()
        {
            ...
            hostBuilder.Services.AddSingleton<HostBuilderFunctions>();
            hostBuilder.Services.AddSingleton<Amazon.Lambda.Serialization.SystemTextJson.DefaultLambdaJsonSerializer>();
            ...
            _ = serviceProvider.GetRequiredService<HostBuilderFunctions>();
        }

        /// <summary>
        /// The generated Lambda function handler for <see cref="Add(int, int, Amazon.Lambda.Core.ILambdaContext)"/>
        /// </summary>
        ...
        public Amazon.Lambda.APIGatewayEvents.APIGatewayHttpApiV2ProxyResponse Add(Amazon.Lambda.APIGatewayEvents.APIGatewayHttpApiV2ProxyRequest __request__, Amazon.Lambda.Core.ILambdaContext __context__)
        {
            ...
            var hostBuilderFunctions = scope.ServiceProvider.GetRequiredService<HostBuilderFunctions>();
