...
namespace TestCustomAuthorizerApp
{
    public class ProtectedFunction_GetProtectedData_Generated
    {
        ...
        /// </summary>
        public ProtectedFunction_GetProtectedData_Generated()
        {
        ...
        /// <summary>
        /// The generated Lambda function handler for <see cref="GetProtectedData(Amazon.Lambda.APIGatewayEvents.APIGatewayHttpApiV2ProxyRequest, Amazon.Lambda.Core.ILambdaContext)"/>
        /// </summary>
        ...
        public Amazon.Lambda.APIGatewayEvents.APIGatewayHttpApiV2ProxyResponse GetProtectedData(Amazon.Lambda.APIGatewayEvents.APIGatewayHttpApiV2ProxyRequest __request__, Amazon.Lambda.Core.ILambdaContext __context__)
        {
            var response = protectedFunction.GetProtectedData(__request__, __context__);
