...
{
    public class ProtectedFunction_HealthCheck_Generated
    {
        ...
        /// </summary>
        public ProtectedFunction_HealthCheck_Generated()
        {
        ...
        /// <summary>
        /// The generated Lambda function handler for <see cref="HealthCheck(Amazon.Lambda.Core.ILambdaContext)"/>
        /// </summary>
        ...
        public Amazon.Lambda.APIGatewayEvents.APIGatewayHttpApiV2ProxyResponse HealthCheck(Amazon.Lambda.APIGatewayEvents.APIGatewayHttpApiV2ProxyRequest __request__, Amazon.Lambda.Core.ILambdaContext __context__)
        {
            var response = protectedFunction.HealthCheck(__context__);
