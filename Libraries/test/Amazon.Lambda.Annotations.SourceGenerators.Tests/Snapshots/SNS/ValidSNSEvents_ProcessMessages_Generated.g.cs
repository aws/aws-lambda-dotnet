...
namespace TestServerlessApp.SNSEventExamples
{
    public class ValidSNSEvents_ProcessMessages_Generated
    {
        ...
        /// </summary>
        public ValidSNSEvents_ProcessMessages_Generated()
        {
        ...
        /// <summary>
        /// The generated Lambda function handler for <see cref="ProcessMessages(Amazon.Lambda.SNSEvents.SNSEvent)"/>
        /// </summary>
        ...
        public void ProcessMessages(Amazon.Lambda.SNSEvents.SNSEvent __evnt__)
        {
            validSNSEvents.ProcessMessages(__evnt__);
        }
