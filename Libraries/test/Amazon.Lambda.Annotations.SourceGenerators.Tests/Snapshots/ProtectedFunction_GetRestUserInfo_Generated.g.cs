...
{
    public class ProtectedFunction_GetRestUserInfo_Generated
    {
        ...
        /// </summary>
        public ProtectedFunction_GetRestUserInfo_Generated()
        {
        ...
        /// <summary>
        /// The generated Lambda function handler for <see cref="GetRestUserInfo(string, string, string, Amazon.Lambda.Core.ILambdaContext)"/>
        /// </summary>
        ...
        public Amazon.Lambda.APIGatewayEvents.APIGatewayProxyResponse GetRestUserInfo(Amazon.Lambda.APIGatewayEvents.APIGatewayProxyRequest __request__, Amazon.Lambda.Core.ILambdaContext __context__)
        {
            ...
            var response = protectedFunction.GetRestUserInfo(userId, email, tenantId, __context__);
