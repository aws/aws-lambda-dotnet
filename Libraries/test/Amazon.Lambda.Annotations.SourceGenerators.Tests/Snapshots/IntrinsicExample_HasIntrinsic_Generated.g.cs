...
namespace TestServerlessApp
{
    public class IntrinsicExample_HasIntrinsic_Generated
    {
        ...
        /// <summary>
        /// The generated Lambda function handler for <see cref="HasIntrinsic(string, Amazon.Lambda.Core.ILambdaContext)"/>
        /// </summary>
        ...
        public void HasIntrinsic(string __text__, Amazon.Lambda.Core.ILambdaContext __context__)
        {
            intrinsicExample.HasIntrinsic(__text__, __context__);
        }
