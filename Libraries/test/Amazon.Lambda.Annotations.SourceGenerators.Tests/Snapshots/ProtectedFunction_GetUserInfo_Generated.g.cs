...
{
    public class ProtectedFunction_GetUserInfo_Generated
    {
        ...
        /// </summary>
        public ProtectedFunction_GetUserInfo_Generated()
        {
        ...
        /// <summary>
        /// The generated Lambda function handler for <see cref="GetUserInfo(string, string, string, Amazon.Lambda.Core.ILambdaContext)"/>
        /// </summary>
        ...
        public Amazon.Lambda.APIGatewayEvents.APIGatewayHttpApiV2ProxyResponse GetUserInfo(Amazon.Lambda.APIGatewayEvents.APIGatewayHttpApiV2ProxyRequest __request__, Amazon.Lambda.Core.ILambdaContext __context__)
        {
            ...
            var response = protectedFunction.GetUserInfo(userId, email, tenantId, __context__);
