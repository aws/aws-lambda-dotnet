...
namespace TestServerlessApp
{
    public class SimpleCalculator_Multiply_Generated
    {
        ...
        public System.IO.Stream Multiply(Amazon.Lambda.APIGatewayEvents.APIGatewayProxyRequest __request__, Amazon.Lambda.Core.ILambdaContext __context__)
        {
            ...
            var result = simpleCalculator.Multiply(x, y);
