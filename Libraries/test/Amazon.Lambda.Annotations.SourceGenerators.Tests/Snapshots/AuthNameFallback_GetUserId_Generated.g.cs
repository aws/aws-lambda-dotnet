...
namespace TestServerlessApp
{
    public class AuthNameFallback_GetUserId_Generated
    {
        ...
        /// </summary>
        public AuthNameFallback_GetUserId_Generated()
        {
            SetExecutionEnvironment();
            authNameFallback = new AuthNameFallback();
            serializer = new Amazon.Lambda.Serialization.SystemTextJson.DefaultLambdaJsonSerializer();
        }

        /// <summary>
        /// The generated Lambda function handler for <see cref="GetUserId(string, Amazon.Lambda.Core.ILambdaContext)"/>
        /// </summary>
        ...
        public async System.Threading.Tasks.Task<Amazon.Lambda.APIGatewayEvents.APIGatewayHttpApiV2ProxyResponse> GetUserId(Amazon.Lambda.APIGatewayEvents.APIGatewayHttpApiV2ProxyRequest __request__, Amazon.Lambda.Core.ILambdaContext __context__)
        {
            ...
            await authNameFallback.GetUserId(userId, __context__);
