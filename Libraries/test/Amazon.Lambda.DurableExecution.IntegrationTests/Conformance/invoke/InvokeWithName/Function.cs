// 5-2: Invoke with name (explicit name parameter)
...
public class Function
{
    ...
    private async Task<string> Workflow(JsonElement input, IDurableContext context)
    {
        ...
        var result = await context.InvokeAsync<string, string>(targetFunctionName, payload, name: name);
        return result;
    }
}
