...
namespace BlueprintBaseName._1
{
    ...
    public class Functions
    {
        ...
        [HttpApi(Amazon.Lambda.Annotations.HttpMethod.Get, "/")]
...
";
        ...
        [LambdaFunction(PackageType = LambdaPackageType.Image)]
        [HttpApi(Amazon.Lambda.Annotations.HttpMethod.Get, "/add/{x}/{y}")]
        ...
        public int Minus(int x, int y, ILambdaContext context)
        {
        ...
        public int Times(int x, int y, ILambdaContext context)
        {
