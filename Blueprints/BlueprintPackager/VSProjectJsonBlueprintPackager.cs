...
namespace Packager
{
    public class VSProjectJsonBlueprintPackager : BaseBlueprintPackager
    {
        
        string _outputDirectory;

        public VSProjectJsonBlueprintPackager(string blueprintRoot, string outputDirectory)
            : base(blueprintRoot)
        {
            _outputDirectory = Path.Combine(outputDirectory, "VisualStudioBlueprintsProjectJson");
